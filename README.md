...
## Repository: https://github.com/awslabs/live-stream-on-aws
...
cd deployment
./build-s3-dist.sh lushostream debate-demo v1.0.0

### 3. Upload the Code to Amazon S3.
aws s3 sync ./regional-s3-assets/ s3://lushostream-us-east-1/debate-demo/v1.0.0/
aws s3 cp global-s3-assets/live-streaming-on-aws.template s3://lushostream-us-east-1/

 ### 4. Launch the CloudFormation template.
Ingresa a la consola de CF =)


![image info](https://wow.zamimg.com/uploads/screenshots/normal/449254-piedra-de-doge.jpg)
